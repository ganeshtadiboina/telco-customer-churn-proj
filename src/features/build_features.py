...
def _map_binary_series(s: pd.Series) -> pd.Series:
    ...
    This function implements the core binary encoding logic that converts categorical features with exactly 2 values into 0/1 integers. The mappings are deterministic and must be consistent b/w training and serving.
...
def build_features(df: pd.DataFrame, target_col: str = "Churn") -> pd.DataFrame:
    ...
    This is the main feature engineering function that transforms raw customer data into ML-ready features. The transformation must be exactly replicated in the serving pipeline to ensure prediction accuracy.
    ...
    # Multi-category features (>2 unique value s)
